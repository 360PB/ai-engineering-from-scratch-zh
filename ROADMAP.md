...
| 03 | GPU 配置与云端 | ✅ | ~75 min |
| 04 | API 与密钥 | ✅ | ~75 min |
| 05 | Jupyter 笔记本 | ✅ | ~75 min |
| 06 | Python 环境 | ✅ | ~75 min |
| 07 | Docker 与 AI | ✅ | ~75 min |
| 08 | 编辑器配置 | ✅ | ~75 min |
| 09 | 数据管理 | ✅ | ~75 min |
| 10 | 终端与 Shell | ✅ | ~45 min |
| 11 | Linux 与 AI | ✅ | ~45 min |
| 12 | 调试与性能分析 | ✅ | ~75 min |
...
| 02 | 多层网络与前向传播 | ✅ | ~75 min |
| 03 | 从零实现反向传播 | ✅ | ~75 min |
| 04 | 激活函数——ReLU、Sigmoid、GELU 及原理 | ✅ | ~45 min |
...
| 07 | [词性标注与句法分析](phases/05-nlp-foundations-to-advanced/07-pos-tagging-parsing) | ✅ | ~45 min |
...
| 17 | [聊天机器人——从基于规则到神经网络](phases/05-nlp-foundations-to-advanced/17-chatbots-rule-to-neural) | ✅ | ~75 min |
...
| 20 | [结构化输出与约束解码](phases/05-nlp-foundations-to-advanced/20-structured-outputs-constrained-decoding) | ✅ | ~60 min |
| 21 | [自然语言推理与文本蕴含](phases/05-nlp-foundations-to-advanced/21-nli-textual-entailment) | ✅ | ~60 min |
| 22 | [嵌入模型深度剖析](phases/05-nlp-foundations-to-advanced/22-embedding-models-deep-dive) | ✅ | ~60 min |
| 23 | [RAG 分块策略](phases/05-nlp-foundations-to-advanced/23-chunking-strategies-rag) | ✅ | ~60 min |
| 24 | [指代消解](phases/05-nlp-foundations-to-advanced/24-coreference-resolution) | ✅ | ~60 min |
