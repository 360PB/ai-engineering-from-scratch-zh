...
- **进度**: Phase 0-13 ✅ (316课), Phase 14-16 部分完成, Phase 17 ✅, Phase 18-19 待翻译（359/435课已翻译）
- **已翻译目录**: `site/phases/`（18个阶段359课），`phases/`（Phase 0-1 完整对照）
...
### Phase 14 — Agent 工程（36/42）

| 01-04 | ✅ 已完成 | 05-06 ✅ 本轮新译 |
| 07-12 | ❌ 待翻译 | 目录已建，无 zh.md |
| 13-42 | ✅ 已完成 | |
...
### Phase 16 — 多 Agent 与 Swarm（24/25）

| 01-24 | ✅ 已完成 | 25 待翻译 |

### Phase 17 — 基础设施与生产部署（6/28）
