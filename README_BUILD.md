...
| 03 | [GPU 配置与云服务](phases/00-setup-and-tooling/03-gpu-setup-and-cloud/) | Build | Python |
...
| 07 | [AI 中的 Docker](phases/00-setup-and-tooling/07-docker-for-ai/) | Build | Docker |
...
| 11 | [AI 中的 Linux](phases/00-setup-and-tooling/11-linux-for-ai/) | Learn | — |
| 12 | [调试与性能分析](phases/00-setup-and-tooling/12-debugging-and-profiling/) | Build | Python |

<details id="phase-1">
<summary><b>Phase 1 — 数学基础</b> &nbsp;<code>22 lessons</code>&nbsp; <em>The intuition behind every AI algorithm, through code.</em></summary>
<br/>
...
| 04 | [机器学习中的微积分：导数与梯度](phases/01-math-foundations/04-calculus-for-ml/) | Learn | Python |
...
| 09 | [信息论：熵、KL 散度](phases/01-math-foundations/09-information-theory/) | Learn | Python |
...
| 15 | [机器学习统计学](phases/01-math-foundations/15-statistics-for-ml/) | Build | Python |
...
| 21 | [机器学习图论](phases/01-math-foundations/21-graph-theory/) | Build | Python |
| 22 | [随机过程](phases/01-math-foundations/22-stochastic-processes/) | Learn | Python |

</details>

<details id="phase-2">
<summary><b>Phase 2 — 机器学习基础</b> &nbsp;<code>18 lessons</code>&nbsp; <em>Classical ML — still the backbone of most production AI.</em></summary>
<br/>
...
<details id="phase-3">
<summary><b>Phase 3 — 深度学习核心</b> &nbsp;<code>13 lessons</code>&nbsp; <em>Neural networks from first principles. No frameworks until you build one.</em></summary>
<br/>

| # | Lesson | Type | Lang |
|:---:|--------|:----:|------|
| 01 | [感知机：一切的起源](phases/03-deep-learning-core/01-the-perceptron/) | Build | Python |
...
| 04 | [激活函数：ReLU、Sigmoid、GELU 及原理](phases/03-deep-learning-core/04-activation-functions/) | Build | Python |
...
<details id="phase-4">
<summary><b>Phase 4 — 计算机视觉</b> &nbsp;<code>28 lessons</code>&nbsp; <em>From pixels to understanding — image, video, 3D, VLMs, and world models.</em></summary>
<br/>
